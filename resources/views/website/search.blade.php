...
{{--                                                    <li class="{{ (isset($sortBy) && $sortBy == 'newness') ? 'active':''}}"><a href="{{route('category_product',[$key->page_slug]).'?sort_by=newness'}}" >Sort by newness</a></li>--}}
{{--                                                    <li class="{{ (isset($sortBy) && $sortBy == 'low_to_high') ? 'active':''}}"><a href="{{route('category_product',[$key->page_slug]).'?sort_by=low_to_high'}}" >Sort by price: low to high</a></li>--}}
{{--                                                    <li class="{{ (isset($sortBy) && $sortBy == 'high_to_low') ? 'active':''}}"><a href="{{route('category_product',[$key->page_slug]).'?sort_by=high_to_low'}}" >Sort by price: high to low</a></li>--}}
{{--                                                </ul>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
                                            ...
                                            <div class="product-inner">
                                                <figure class="product-image has--bg">
                                                    <div class="product-image--holder">
                                                        <a
                                                            href="{{ route('category_product', [$key->cat_slug, $key->product_slug]) }}">
                                                            <img src="{{ asset('images/uploads/products/' . $key->product_image) }}"
                                                                 alt="{{ $key->name }}" class="primary-image">
                                                        </a>
                                                        <a
                                                            href="{{ route('category_product', [$key->cat_slug, $key->product_slug]) }}">
                                                            <img src="{{ asset('images/uploads/products/' . $key->product_image) }}"
                                                                 alt="{{ $key->name }}" class="secondary-image">
                                                        </a>
                                                    </div>
