...
<div style="position:relative; max-width:650px; display:block; padding:2%; margin:auto; border:2px solid #f0f0f0; background-color:#264796;">
    <div style="position:relative; display:block; padding:20px; background-color: #fafafa;">
        ...
        <p style="font-size:11px; color:#333; line-height:175%; font-family: 'Poppins', sans-serif; font-weight:500; text-align:center; margin:0; padding:0 0 15px;letter-spacing:1px;">
            Thank you for your registering with us.</p>
        <h2 style="color:#d82326; font-family:'Lato', sans-serif; font-weight:600; font-size:24px; line-height:40px; text-transform: none; text-align: center; margin:0; padding:5px 0 10px;">Your Login Details</h2>
        <p style="font-size:11px; color:#333; line-height:175%; font-family: 'Poppins', sans-serif; font-weight:400; text-align:center; margin:0; padding:0 0 15px;letter-spacing:1px;">
            ...
            Password: **** <i style="color:#777;">(as set by you.)</i></p>
        <p style="font-size:14px; color:#333; line-height:175%; font-family: 'Poppins', sans-serif; font-weight:600; text-align:center; margin:0; padding:0 0 15px;letter-spacing:1px;">
            Just <a href="https://www.manamatoppings.com/login" style="font-size:14px;color:#111111; font-weight:bold" >click to login</a><br>& exprience a fruitful journey.</p>
        <p style="font-size:11px; color:#333; line-height:175%; font-family: 'Poppins', sans-serif; font-weight:400; text-align:center; margin:0; padding:0 0 15px;letter-spacing:1px;">
