...
<div style="position:relative; max-width:650px; display:block; padding:2%; margin:auto; border:2px solid #f0f0f0; background-color:#264796;">
    <div style="position:relative; display:block; padding:20px; background-color: #fafafa;">
        ...
        <h1 style="color:#e31e24; font-family:'Lato', sans-serif; font-weight:700; font-size:30px; line-height:100%; text-transform: none; text-align: center; margin:0; padding:35px 0 0;">
            ...
            <span style="color:#111111; font-family: 'Poppins', sans-serif; font-size:24px; font-weight:600; display:block; margin:0; padding:0;">{{$username}}</span></h1>
        <h2 style="color:#d82326; font-family:'Lato', sans-serif; font-weight:600; font-size:24px; line-height:125%; text-transform: none; text-align: center; margin:0; padding:5px 0 10px;">
            <font color="#111111" style="font-size:20px;">Your Order </font># {{$order_no}}.</h2>
        <p style="font-size:11px; color:#333; line-height:175%; font-family: 'Poppins', sans-serif; font-weight:400; text-align:center; margin:0; padding:0 0 15px;letter-spacing:1px;">
            {{$order_message}}
            <br>
            <a href="https://www.manamatoppings.com/account/my-account" style="font-size:14px;color:#111111; font-weight:bold" >Your Dashboard</a>
            <br><br>
            Or, if you cannot click the link above, copy paste the below url in your browser.<br>
            <i>https://www.manamatoppings.com/account/my-account</i></p>
        <p style="font-size:12px; color:#333; line-height:175%; font-family: 'Poppins', sans-serif; font-weight:400; text-align:center; margin:0; padding:0 0 15px;letter-spacing:1px;">
            If you have any questions, <a href="https://www.manamatoppings.com/contact-us/" style="color:#111111; font-weight:bold" >get in touch</a> and we will surely assist you.</p>
